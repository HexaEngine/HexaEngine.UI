namespace HexaEngine.Graphics.Renderers
{
    ...
    public unsafe class UIRenderer
    {
        ...
        private void CreateDeviceObjects()
        {
            ...
            {
                VertexShader = "HexaEngine.UI:shaders/prim/vs.hlsl",
                PixelShader = "HexaEngine.UI:shaders/prim/ps.hlsl"
            }, stateDesc);
            ...
            {
                VertexShader = "HexaEngine.UI:shaders/tex/vs.hlsl",
                PixelShader = "HexaEngine.UI:shaders/tex/ps.hlsl"
            }, stateDesc);
            ...
            {
                VertexShader = "HexaEngine.UI:shaders/vec/vs.hlsl",
                PixelShader = "HexaEngine.UI:shaders/vec/ps.hlsl"
            }, stateDesc);
